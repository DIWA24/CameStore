      ...
      <ul class="nav navbar-nav">
        ...
        <li><a href="services">SERVICES</a></li>
		  ...
		  <li>&nbsp; &nbsp; &nbsp; &nbsp;</li>
		    ...
		    <li><a href="CustomerCheck"><span class="glyphicon glyphicon-log-in">LOG IN</a></li>
        <li><a href="customerSignUp"><span class="glyphicon glyphicon-user"> SIGN UP</a></li>
      </ul>
    </div>
  </div>
</nav>
<br>
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="resources/images/camera1.jpg" alt="Chania" style="width:800px; height:400px">
      ...
      <div class="item">
        <img src="resources/images/camera2.jpg" alt="Chania" style="width:800px; height:400px">
        <div class="carousel-caption">
         <form class="form-inline" role="form">
          <div class="form-group">
      <!-- <button type="button" class="btn btn-danger">Search</button><input type="text" class="form-control" id="pwd" placeholder="Enter Something"> -->
      ...
      <div class="item">
        <img src="resources/images/camera3.jpg" alt="Flower" style="width:800px; height:400px">
        <div class="carousel-caption">
         <form class="form-inline" role="form">
          <div class="form-group">
      <!--  <button type="button" class="btn btn-danger">Search</button><input type="text" class="form-control" id="pwd" placeholder="Enter Something">-->
      ...
      <div class="item">
        <img src="resources/images/camera4.jpg" alt="Flower" style="width:800px; height:400px">
        <div class="carousel-caption">
         <form class="form-inline" role="form">
          <div class="form-group">
      <!-- <button type="button" class="btn btn-danger">Search</button><input type="text" class="form-control" id="pwd" placeholder="Enter Something">-->
...
<div>
 <center><h3>Featured cameras</h3></center>
<hr></hr>
</div>
<div class="container">
